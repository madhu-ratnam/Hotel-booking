...
const ExclusiveOffers = () => {
    return (
        ...
        pt-20 pb-30'>
            ...
            w-full'>
                <Title align='left' title='Exclusive Offers' subTitle='Take advantage of our limited-time and special packages
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12'>
                {exclusiveOffers.map((item) => (
                    ...
                    justify-between gap-1 md:pt-18 px-4 rounded-xl text-white
